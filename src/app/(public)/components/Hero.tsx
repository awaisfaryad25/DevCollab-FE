    ...
    <section className="relative overflow-hidden px-4 py-24 text-center md:py-36">
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/auth/register"
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-violet-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-violet-700 sm:w-auto"
          >
            Start for free
