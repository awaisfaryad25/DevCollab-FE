...
const CTABanner = () => {
  return (
    <section className="px-4 py-24">
      <div className="mx-auto max-w-3xl rounded-2xl bg-violet-600 px-8 py-16 text-center">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/auth/register"
            className="flex items-center gap-2 rounded-lg bg-white px-6 py-3 text-sm font-medium text-violet-600 hover:bg-violet-50"
          >
